...
Esses sistemas ainda são um subconjunto: faltam alvos e interações especiais, animações e tempos exatos, água, chefes, puzzles e integração plena com o save RMS. Algumas representações de objetos são provisórias. Uma fase carregar não significa que pode ser concluída corretamente.
