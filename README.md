...
O guardião de Tibet agora usa `mm1.f` e cinco segmentos de vida. O martelo de gelo congela os inimigos da arena em blocos empurráveis; os blocos em queda ferem o chefe. Os interruptores alternam as barreiras de gelo e criam novos alvos, enquanto o ataque forte desperta as pedras suspensas do teto. Movimento, ataques, derrota e reinício seguem `cGame.method_281/282`. A entrada normal da arena ainda precisa ser corrigida: a barreira à direita do corredor inicial permanece fechada no port, portanto a luta só foi validada com posicionamento de teste dentro da arena.
