...
Esses sistemas ainda são um subconjunto: faltam alvos e interações especiais, tempos exatos de algumas animações, água, o chefe de Tibet, outros puzzles e integração plena com o save RMS. Algumas representações de objetos são provisórias. Uma fase carregar não significa que pode ser concluída corretamente.
