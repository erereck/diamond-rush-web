...
| Campanha / cenas / menus | Menu S700, mapas dos três mundos e abertura guiada de Angkor índice 13 com os seis roteiros originais de `demo.f`; conclusão retorna ao mapa | Tutorial jogável com gatilhos manuais e física completa, regras canônicas de desbloqueio, save RMS e demais cenas |
...
5. Integrar campanha e save RMS, ampliar a execução de `DemoInterpreter` para as demais cenas e tornar o tutorial índice 13 jogável pelos gatilhos do mapa, com regras de progressão originais.
