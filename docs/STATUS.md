...
| Relógio e câmera | Inteiros, 20 Hz, teste independente de refresh; abertura comparada por 21 estados e marcos do primeiro roteiro em trace Java | Estender trace às demais cenas e fases jogáveis |
...
1. Expandir o trace da decompilação S700 recompilada, que já compara 21 estados iniciais e os marcos do primeiro diálogo, para entradas, arrays e mudanças de estado nas demais cenas/fases. Executar também o JAR original para comparar bytecode e comportamento.
