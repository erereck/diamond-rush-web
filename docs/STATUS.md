...
| Perigos de Bavaria e Tibet | Roladores de Bavaria (tile 14) caem e seguem a direção do mapa; armadilhas duplas (16) são formadas a partir do mapa e atacam após aproximação; espinhos (28) usam os dois relógios de 89/44 ticks e o sprite correto; pedras de teto de Tibet (44) avisam, despencam, atingem entidades e se desfazem. Estados entram no checkpoint e replay | Interações especiais das armadilhas, inimigos 45/46/49, água, puzzles e tempos finos ainda pendentes |
...
| Campanha / cenas / menus | Menu S700, mapas dos três mundos, seis cenas da abertura, dois roteiros de recuperação, oito gatilhos de mapa e quatro cenas de baú de `demo.f`, com física ativa durante as cenas; conclusão retorna ao mapa; quatro recompensas por fase registradas individualmente | Paridade fina dos eventos e animações J2ME, save RMS e seis roteiros sem gatilho ativo nesta versão |
