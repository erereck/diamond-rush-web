...
- A build local atual abriu no Chromium integrado sem erros de console. O menu S700 foi conferido visualmente; os efeitos das armas ainda não foram comparados visualmente com a execução J2ME original.
